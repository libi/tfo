...
export const messages = {
    en: {
        ...
        settingsDataDirDesktopHint: 'To change the data directory, click the folder icon in the desktop app\'s popup window.',
        ...
        editSave: 'Save',
        editCancel: 'Cancel',
        deleteConfirmTitle: 'Delete this fragment?',
        deleteConfirmMessage: 'This will permanently delete the file {filename}. This action cannot be undone.',
        ...
        editSaveError: 'Failed to save. Please try again.',
    },
    'zh-CN': {
        ...
        settingsDataDirDesktopHint: '如需修改数据目录，请点击桌面应用弹窗左下角的文件夹图标。',
        ...
        editSave: '保存',
        editCancel: '取消',
        deleteConfirmTitle: '删除此碎片？',
        deleteConfirmMessage: '将永久删除文件 {filename}，此操作不可撤销。',
        deleteConfirmButton: '确认删除',
        deleteConfirmCancel: '取消',
        deletingContent: '删除中…',
        deleteSuccess: '碎片已删除。',
        deleteError: '删除失败，请稍后重试。',
        editSaveSuccess: '保存成功！',
        editSaveError: '保存失败，请稍后重试。',
    },
} as const;
