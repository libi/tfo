...
export const messages = {
    en: {
        ...
        hotkeyGlobalToggleLabel: 'Global toggle (desktop app)',
        hotkeyGlobalToggleHint: 'Open/close the quick capture popup from anywhere. Requires desktop app.',
    ...
    'zh-CN': {
        ...
        hotkeyGlobalToggleLabel: '全局唤起（桌面端）',
        hotkeyGlobalToggleHint: '在任意界面打开/关闭快闪记事窗口，需使用桌面端。',
