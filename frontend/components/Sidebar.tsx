...
export function Sidebar({ tags, selectedTag, onSelectTag, selectedDate, onSelectDate, onOpenClawBot }: SidebarProps) {
  ...
  return (
    <aside className="w-64 border-r border-gray-200 bg-[#f7f7f7] flex flex-col h-full shrink-0">
      <div className="p-6">
        <h1 className="text-xl font-medium tracking-tight text-gray-900 mb-1">TFO</h1>
        <p className="text-xs text-gray-500">Local-first knowledge capsule</p>
      </div>
      ...
      <div className="p-4 border-t border-gray-200 space-y-2">
        ...
        <button className="w-full flex items-center gap-2 px-3 py-2 text-sm text-gray-700 hover:bg-gray-200 rounded-md transition-colors">
          <Settings size={16} />
          Settings
        </button>
      </div>
